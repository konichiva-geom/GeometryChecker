# Интерпретация
Н ужно идти параллельно с деревом, и в траай кетч ловить исключение, нааходясь в дереве. Выводить range элементов этого поддерева.
# Фронт
Сделать, что в plain можно писать markdown. Юзать можно [эту](https://openbase.com/js/marked) либу.
